...
export function SectionCards() {
  ...
  const avgCtr = totalsComputed.impressions
    ? (totalsComputed.clicks / totalsComputed.impressions) * 100
    : 0;
  const roas = totalsComputed.spend
    ? (totalsComputed.conversions * 10) / totalsComputed.spend
    : 0;
  return (
